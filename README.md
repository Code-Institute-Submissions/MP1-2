...
## UX
The main purpose of this website is to introduce Rui to the job market, both to recruiters and potential clients.
This is done through a simple, easy to navigate and clean looking website.  
In this website, it's possible to get to know Rui Oliveira, his education background and what he does, see and 
access Rui's portfolio, contact Rui Oliveira and download Rui's CV.  
This website is my first milestone project for the diploma in software development from the [code institute](https://codeinstitute.net).  
A live view of this website can be found here: [Rui Oliveira](https://ruioliveira83.github.io/MP1).
